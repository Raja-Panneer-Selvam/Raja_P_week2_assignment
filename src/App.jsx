...
function App() {
  ...
  return (
    <div className="container">
      <nav className="navbar navbar-expand-lg nav nav-pills py-3">
        <Link className="navbar-brand" to="/">
          ...
          <span className="travel">Travel Journal</span>
        </Link>
        <div className="collapse navbar-collapse">
          <ul className="navbar-nav mr-auto">
            <li className="nav-item">
              <Link
                className={`nav-link ${
                  location.pathname === "/" ? "active text-light" : "text-dark"
                } `}
                to="/"
              >
                Home
      ...
      <Routes>
        ...
        <Route
          path="/edit/:id"
          element={<EditEntry entries={entries} updateEntry={updateEntry} />}
        />
        <Route
          path="/entries"
          element={<EntryList entries={entries} deleteEntry={deleteEntry} />}
        />
      </Routes>
    </div>
  );
